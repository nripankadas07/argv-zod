        ...
        argv-zod exists to solve a narrow, inspectable developer-tooling problem:
        Type-safe argv parser with a Zod-style fluent schema builder; inferred result types, env fallbacks, aliases, defaults.
        ...
        Topics: argv, cli, release-track, schema, type-safe, typescript, zero-dependencies
